...
export default function Todo() {
  const [listas, setListas] = useState(() => {
    return JSON.parse(localStorage.getItem("listas")) || { "Minha Lista": [] };
  });
  const [listaAtiva, setListaAtiva] = useState("Minha Lista");
  ...
  function adicionarTarefa() {
    ...
    if (tarefa === "") {
      ...
      setListas({
        ...listas,
        [listaAtiva]: [...listas[listaAtiva], tarefa],
      });
  ...
  function editarTarefa(index) {
    const nova = prompt("Edite a tarefa:", listas[listaAtiva][index]);
    if (nova && nova.trim() !== "") {
      const novas = [...listas[listaAtiva]];
      novas[index] = nova.trim();
      setListas({
        ...listas,
        [listaAtiva]: novas,
      });
